...
class ArticlePage(ExtTestCase):
    def test_reverse_article(self):
        self.assertEqual(reverse('plok:article', args=['test_blog', 'test_article']),
    ...
    def test_get_absolute_url(self):
        ...
        self.assertEqual(article.get_absolute_url(), reverse('plok:article', args=['test_blog', 'test_article']))

    def test_uses_correct_template(self):
        user = self.create_and_log_in_user()
        blog = Blog.objects.create(created_by=user, name="test_blog")
        article = Article.objects.create(blog=blog, created_by=user, name="test_article")
        response = self.client.get(reverse('plok:article', args=[blog.name, article.name]))
    ...
    def test_default_context(self):
        ...
        response = self.client.get(reverse('plok:article', args=['test_blog', 'test_article']))
...
class CreateArticlePage(ExtTestCase):
    def test_reverse_article_create(self):
        self.assertEqual(reverse('plok:article_create', args=['test_blog']), '/plok/test_blog/create_article/')

    def test_uses_correct_template(self):
        user = self.create_and_log_in_user()
        blog = Blog.objects.create(created_by=user, name="test_blog", title="Test blog")
        response = self.client.get(reverse('plok:article_create', args=[blog.name]))
    ...
    def test_can_create_new_article(self):
        ...
        response = self.client.post(reverse(
            'plok:article_create', args=[blog.name]),
            {
                'name': 'test_article',
                'blog_name': 'test_blog',
                'title': 'Test article',
    ...
    def test_cant_create_article_with_existing_name(self):
        ...
        response = self.client.post(
            reverse('plok:article_create', args=[blog.name]),
            {
                'blog_name': blog.name,
                'name': 'test_article',
                'title': 'Test blog',
...
class UpdateArticlePage(ExtTestCase):
    def test_reverse_article_edit(self):
        self.assertEqual(reverse('plok:article_update', args=['test_blog', 'test_article']),
    ...
    def test_get_edit_url(self):
        ...
        blog = Blog.objects.create(created_by=user, name="test_blog")
        article = Article.objects.create(blog=blog, created_by=user, name="test_article")
        self.assertEqual(article.get_edit_url(), reverse('plok:article_update', args=['test_blog', 'test_article']))

    def test_uses_correct_template(self):
        user = self.create_and_log_in_user()
        blog = Blog.objects.create(created_by=user, name="test_blog")
        Article.objects.create(blog=blog, created_by=user, name="test_article")
        response = self.client.get(reverse('plok:article_update', args=['test_blog', 'test_article']))
        self.assertTemplateUsed(response, 'plok/article_form.html')
    ...
    def test_can_update_article(self):
        ...
        response = self.client.post(reverse('plok:article_update', args=[blog.name, article.name]),
...
class DeleteArticlePage(ExtTestCase):
    def test_reverse_blog_delete(self):
        self.assertEqual(reverse('plok:article_delete', args=['test_blog', 'test_article']),
    ...
    def test_uses_correct_template(self):
        ...
        blog = Blog.objects.create(created_by=user, name="test_blog")
        article = Article.objects.create(created_by=user, blog=blog, name="test_article", title="Test article")
        response = self.client.get(reverse('plok:article_delete', args=[blog.name, article.name]))
    ...
    def test_404_no_article(self):
        ...
        response = self.client.get(reverse('plok:article_delete', args=['test_blog', 'test_article']))
        self.assertTemplateUsed(response, '404.html')
